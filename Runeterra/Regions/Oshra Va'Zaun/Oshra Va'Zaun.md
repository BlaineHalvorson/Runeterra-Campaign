 Oshra Va'Zaun is the name of the combined regions of [[Piltover]] and [[Zaun]] that control the major trade routes between [[Valoran]] and [[Shurima (Continent)|Shurima]]. Home both to visionary inventors and their wealthy patrons, the divide between social classes is becoming more dangerous.


# Map
```leaflet
id: OshraVaZaunMap ### Must be unique with no spaces  
image: [[Oshra Va'Zaun.jpg]] ### Link to the map image file. Do not add a ! in front of the image  
